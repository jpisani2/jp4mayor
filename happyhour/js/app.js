...
/* ---------- map ---------- */
const W=1000,H=1551,LNG0=-83.452,LNG1=-83.122,LAT1=42.492,LAT0=42.1179;
...
CITIES.forEach(c=>{const t=el("text",{x:X(c[2]),y:Y(c[1]),"text-anchor":"middle",fill:"var(--road-major)","font-family":FONT,"font-weight":"700","font-size":String(c[3]||24),"letter-spacing":c[3]?"2":"3"},gRoads);t.textContent=c[0];});
EW.forEach(r=>{const mile=/Mile/.test(r[0]);el("line",{x1:r[2]!=null?X(r[2]):-3000,x2:r[3]!=null?X(r[3]):4000,y1:Y(r[1]),y2:Y(r[1]),stroke:mile?"var(--road-major)":"var(--road)","stroke-width":mile?4:3},gRoads);});
...
HWY.forEach(r=>{el("polyline",{points:pts(r[1]),fill:"none",stroke:"var(--road-major)","stroke-width":9,"stroke-linejoin":"round",opacity:.8},gRoads);el("polyline",{points:pts(r[1]),fill:"none",stroke:"var(--mapbg)","stroke-width":2.5,"stroke-linejoin":"round","stroke-dasharray":"14 10"},gRoads);});
ISLANDS.forEach(i=>{const t=el("text",{x:X(i[2][1]),y:Y(i[2][0]),"text-anchor":"middle",fill:"var(--road-major)","font-family":FONT,"font-weight":"700","font-size":"18","letter-spacing":"2"},gRoads);t.textContent=i[0];});
{const t=el("text",{x:X(-83.128),y:Y(42.205),"text-anchor":"middle",fill:"var(--roadlabel)","font-family":FONT,"font-weight":"700","font-size":"18","letter-spacing":"4",transform:`rotate(-72 ${X(-83.128)} ${Y(42.205)})`},gRoads);t.textContent="DETROIT RIVER";}
const labels=[];
