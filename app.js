...
(function () {
  ...
  function renderPhotos() {
    ...
    var photos = S.photos || [];
    if (!photos.length) {
      grid.appendChild(emptyNote("No pictures yet. Add them to the <code>photos</code> list in <code>content.js</code>."));
      return;
    }
  ...
  function init() {
    ...
    renderHeader();
    wireLightbox();
    if ($("#project-root")) renderProject();
    else if ($("#projects-list")) initIndex();
  }
